      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(15),
            side: const BorderSide(color: Colors.lightGreen, width: 2), // Light green border
          ),
          title: const Text(
            'Confirm Log Out',
            style: TextStyle(
              color: Colors.green, // Professional green title
          ...
          actions: [
            ...
            TextButton(
              ...
              style: TextButton.styleFrom(
                backgroundColor: Colors.lightGreen[100], // Light green tint
                shape: RoundedRectangleBorder(
              ...
              child: const Padding(
                ...
                child: Text(
                  'Cancel',
                  style: TextStyle(
                    color: Colors.green, // Green text for consistency
                    fontWeight: FontWeight.bold,
                    fontSize: 16,
                  ),
                ),
            ...
            TextButton(
              ...
              style: TextButton.styleFrom(
                backgroundColor: Colors.redAccent[100], // Soft red tint
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8),
                ),
              ),
              child: const Padding(
                ...
                child: Text(
                  'Log Out',
                  style: TextStyle(
                    color: Colors.red, // Strong red for alert action
                    fontWeight: FontWeight.bold,
                    fontSize: 16,
                  ),
                ),
